...
FetchContent_Declare(Horizon
    ...
    GIT_TAG 4b145f9f97ac826764ab9dac82bf9a38a2a91c87
    EXCLUDE_FROM_ALL
)
...
if(CORONA_BUILD_VISION AND WIN32 AND NOT DEFINED ENV{CUDA_PATH})
    file(GLOB _corona_cuda_candidates LIST_DIRECTORIES true
        "$ENV{ProgramFiles}/NVIDIA GPU Computing Toolkit/CUDA/v*")
    if(_corona_cuda_candidates)
        list(SORT _corona_cuda_candidates COMPARE NATURAL ORDER DESCENDING)
        list(GET _corona_cuda_candidates 0 _corona_cuda_path)
        set(ENV{CUDA_PATH} "${_corona_cuda_path}")
        message(STATUS "[3rdparty] CUDA_PATH was not set; using detected CUDA install: ${_corona_cuda_path}")
    endif()
    unset(_corona_cuda_candidates)
    unset(_corona_cuda_path)
endif()
...
if(CORONA_BUILD_VISION)
    ...
    if(DEFINED ENV{CUDA_PATH})
        ...
        set(HORIZON_BUILD_VISION_HOTFIX OFF CACHE BOOL "" FORCE)
        message(STATUS "[3rdparty] Horizon Vision hotfix disabled because CUDA_PATH is not set; Ocarina targets will not be available")
    endif()
endif()
