...
1. `README.md`
2. `docs/overview/PROJECT_SUMMARY_cn.md`
3. `docs/architecture/SYSTEMS_OVERVIEW_cn.md`
4. `docs/architecture/DATA_FLOW_OVERVIEW_cn.md`
5. `docs/architecture/SOURCE_INDEX_cn.md`
...
- 想看全局介绍：`docs/overview/PROJECT_SUMMARY_cn.md`
- 想看系统职责：`docs/architecture/SYSTEMS_OVERVIEW_cn.md`
- 想看数据怎么流动：`docs/architecture/DATA_FLOW_OVERVIEW_cn.md`
- 想快速定位源码：`docs/architecture/SOURCE_INDEX_cn.md`
- 想看 Python API 怎么落到存储：`docs/scripting/PYTHON_API_STORAGE_MAPPING_cn.md`
- 想看哪些能力真的可用：`docs/overview/CAPABILITY_STATUS_cn.md`
- 想看现在最值得修的问题：`docs/overview/ISSUES_AND_RECOMMENDATIONS_cn.md`
