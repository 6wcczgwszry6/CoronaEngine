...
class VisionExporter(bpy.types.Operator, ExportHelper):
    ...
    def correct_matrix(self, mat=None):
        # Global Blender->Vision axis remap used by shapes and light/world-space
        # transforms. This only changes the world basis: Blender is Z-up, while
        # Vision scenes are authored in Y-up. Light-specific local-axis fixes,
        # such as area/spot emission direction adjustments, are applied later by
        # dedicated helpers on top of this shared conversion.
