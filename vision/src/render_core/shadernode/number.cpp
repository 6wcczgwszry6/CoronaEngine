...
protected:
    [[nodiscard]] uint64_t compute_hash() const noexcept override { return hash64_list(value_.hv()); }
...
public:
    ...
    bool render_UI_by_tag(Widgets *widgets, vision::AttrTag attr_tag) noexcept override {
