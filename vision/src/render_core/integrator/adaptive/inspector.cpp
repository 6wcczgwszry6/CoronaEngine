...
void ConvergenceInspector::prepare() noexcept {
    ...
    variance_stats_.super() = device().create_buffer<VarianceStats>(pipeline()->pixel_num(), "ConvergenceInspector::VarianceStats");
    variance_stats_.register_self();
}

CommandBatch ConvergenceInspector::reset() noexcept {
...
bool ConvergenceInspector::render_UI(Widgets *widgets) noexcept {
...
void ConvergenceInspector::render_sub_UI(Widgets *widgets) noexcept {
