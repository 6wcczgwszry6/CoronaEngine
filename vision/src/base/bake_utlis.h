...
struct BakedShape : public Toolkit {
private:
    ShapeInstance *shape_{};
    Texture3D lightmap_tex_;
...
public:
    ...
    [[nodiscard]] CommandBatch save_lightmap_to_cache() const;
    [[nodiscard]] CommandBatch save_rasterize_map_to_cache() const;
