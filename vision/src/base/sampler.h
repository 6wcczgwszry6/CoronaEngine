...
public:
    ...
    virtual void set_seed(const Uint2 &pixel, const Uint &sample_index, const Uint &dim) noexcept = 0;
    void set_seed(const Uint2 &pixel, const Uint &sample_index, Dimension dim) noexcept {
        set_seed(pixel, sample_index, to_underlying(dim));
    }
