...
public:
    ...
    [[nodiscard]] float3 prev_host_position() const noexcept { return prev_pos_.hv(); }
    ...
    [[nodiscard]] float4x4 host_c2w() const noexcept;
    ...
    void set_position(float3 pos) noexcept { position_ = pos; }
