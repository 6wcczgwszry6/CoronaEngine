...
TLight AssimpParser::spot_light(aiLight *ai_light) noexcept {
    ...
    DataWrap o2w = DataWrap::object();
    DataWrap o2w_param = DataWrap::object();
    o2w["type"] = "look_at";
    o2w_param["position"] = to_json(pos);
    o2w_param["target_pos"] = to_json(pos + direction);
    o2w_param["up"] = to_json(up);
    o2w["param"] = o2w_param;
    param["o2w"] = o2w;
