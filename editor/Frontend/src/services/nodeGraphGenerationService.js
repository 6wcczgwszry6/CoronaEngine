...
const MUTATION_PATTERN = /(\u751f\u6210|\u5236\u4f5c|\u521b\u5efa|\u642d\u5efa|\u5b9e\u73b0|\u5f04(?:\u4e00\u4e2a|\u4e2a)?|\u505a(?:\u4e00\u4e2a|\u4e2a)?|\u7f16\u8f91|\u4fee\u6539|\u6539(?:\u6210|\u4e3a)|\u66ff\u6362(?:\u6210|\u4e3a)|\u6362(?:\u6210|\u4e3a)|\u8c03\u6574(?:\u6210|\u4e3a)|\u8bbe\u7f6e(?:\u6210|\u4e3a)|\u8bbe(?:\u6210|\u4e3a)|\u53d8(?:\u6210|\u4e3a)|\u8865\u5145|\u589e\u52a0|\u6dfb\u52a0|\u6269\u5c55|\u52a0(?:\u4e0a|\u5165|\u4e00\u4e2a|\u4e2a)?|\u5220\u9664|\u79fb\u9664|\u91cd\u505a|\u6539\u9020|generate|create|build|make|edit|modify|add|extend|delete|remove)/i;
const TARGET_PATTERN = /(\u6e38\u620f|demo|deno|\u73a9\u6cd5|\u529f\u80fd|\u6548\u679c|\u884c\u4e3a|\u673a\u5236|\u4ea4\u4e92|\u64cd\u4f5c|\u89c4\u5219|\u6d41\u7a0b|\u72b6\u6001\u673a|\u53c2\u6570|\u6570\u503c|\u901f\u5ea6|\u89d2\u5ea6|\u5bf9\u8c61\u5f15\u7528|\u5f15\u7528|\u8282\u70b9|\u79ef\u6728|\u903b\u8f91|\u573a\u666f|\u7269\u4f53|\u5bf9\u8c61|\u6a21\u578b|\u7403|\u6444\u50cf\u673a|\u79fb\u52a8|\u8df3\u8dc3|\u78b0\u649e|\u63a7\u5236|\u6309\u952e|\u6309\u4e0b|\u8f93\u5165|\u4e8b\u4ef6|\u952e\u76d8|\u9f20\u6807|\u7a7a\u683c|wasd|game|gameplay|feature|behavior|mechanic|interaction|block|node|logic|scene|object|actor|model|camera|move|jump|collision|control|input|event)/i;
const IMPERATIVE_PREFIX_PATTERN = /(?:^|[\s\u3002\uff0c,!.\uff01?\uff1f])(?:(?:\u8ba9)?\u5305\u83dc[\s\u3001\u3002\uff0c,.:\uff1a]*)?(?:\u5e2e\u6211|\u5e2e\u5fd9|\u8bf7(?:\u4f60)?|\u7ed9\u6211|\u66ff\u6211|\u4e3a\u6211|\u9ebb\u70e6|\u6211\u8981|\u6211\u60f3(?:\u8ba9\u4f60)?|\u80fd\u5426|\u53ef\u4ee5(?:\u5e2e\u6211)?|please|could you|i want you to)/i;
const LEADING_MUTATION_PATTERN = /^(?:(?:\u8bf7(?:\u4f60)?|\u9ebb\u70e6|\u5e2e\u6211|\u5e2e\u5fd9|\u7ed9\u6211|\u66ff\u6211|\u4e3a\u6211)\s*)?(?:\u751f\u6210|\u5236\u4f5c|\u521b\u5efa|\u642d\u5efa|\u5b9e\u73b0|\u505a(?:\u4e00\u4e2a|\u4e2a)?|\u7f16\u8f91|\u4fee\u6539|\u6539(?:\u6210|\u4e3a)|\u66ff\u6362(?:\u6210|\u4e3a)|\u6362(?:\u6210|\u4e3a)|\u8c03\u6574(?:\u6210|\u4e3a)|\u8bbe\u7f6e(?:\u6210|\u4e3a)|\u8bbe(?:\u6210|\u4e3a)|\u53d8(?:\u6210|\u4e3a)|\u8865\u5145|\u589e\u52a0|\u6dfb\u52a0|\u6269\u5c55|\u52a0(?:\u4e0a|\u5165|\u4e00\u4e2a|\u4e2a)?|\u5220\u9664|\u79fb\u9664|\u91cd\u505a|\u6539\u9020|generate|create|build|make|edit|modify|add|extend|delete|remove)/i;
const OBJECT_IMPERATIVE_PATTERN = /^(?:(?:\u8bf7(?:\u4f60)?|\u9ebb\u70e6)\s*)?(?:\u7ed9|\u4e3a|\u628a|\u5c06)(?:\u5f53\u524d|\u8fd9\u4e2a|\u8be5|\u6211\u7684)?[^\u3002\uff01\uff1f!?\n]{0,64}?(?:\u751f\u6210|\u5236\u4f5c|\u521b\u5efa|\u642d\u5efa|\u5b9e\u73b0|\u505a(?:\u4e00\u4e2a|\u4e2a)?|\u7f16\u8f91|\u4fee\u6539|\u6539(?:\u6210|\u4e3a)|\u66ff\u6362(?:\u6210|\u4e3a)|\u6362(?:\u6210|\u4e3a)|\u8c03\u6574(?:\u6210|\u4e3a)|\u8bbe\u7f6e(?:\u6210|\u4e3a)|\u8bbe(?:\u6210|\u4e3a)|\u53d8(?:\u6210|\u4e3a)|\u8865\u5145|\u589e\u52a0|\u6dfb\u52a0|\u6269\u5c55|\u52a0(?:\u4e0a|\u5165|\u4e00\u4e2a|\u4e2a)?|\u5220\u9664|\u79fb\u9664|\u91cd\u505a|\u6539\u9020|generate|create|build|make|edit|modify|add|extend|delete|remove)/i;
const REPLACEMENT_COMMAND_PATTERN = /^(?:(?:\u8bf7(?:\u4f60)?|\u9ebb\u70e6|\u5e2e\u6211|\u5e2e\u5fd9|\u7ed9\u6211|\u66ff\u6211|\u4e3a\u6211)\s*)?(?:(?:\u5c06|\u628a)\s*)?[^\u3002\uff01\uff1f!?\n]{0,80}?(?:\u4fee\u6539(?:\u6210|\u4e3a)|\u6539(?:\u6210|\u4e3a)|\u66ff\u6362(?:\u6210|\u4e3a)|\u6362(?:\u6210|\u4e3a)|\u8c03\u6574(?:\u6210|\u4e3a)|\u8bbe\u7f6e(?:\u6210|\u4e3a)|\u8bbe(?:\u6210|\u4e3a)|\u53d8(?:\u6210|\u4e3a))/i;
...
const EDIT_PATTERN = /(\u4fee\u6539|\u6539(?:\u6210|\u4e3a)|\u66ff\u6362(?:\u6210|\u4e3a)|\u6362(?:\u6210|\u4e3a)|\u8c03\u6574(?:\u6210|\u4e3a)|\u8bbe\u7f6e(?:\u6210|\u4e3a)|\u8bbe(?:\u6210|\u4e3a)|\u53d8(?:\u6210|\u4e3a)|\u7f16\u8f91|\u6539\u9020|\u91cd\u505a|\u8c03\u6574|edit|modify|rebuild|change|replace)/i;
...
export function nodeGraphGenerationIntent(text) {
  ...
  if (!instruction
    ...
    || (!hasImperativePrefix && !startsWithMutation && !hasObjectImperative && !hasReplacementCommand)
...
export async function generateNodeGraphFromInstruction(instruction, operation = 'create') {
  ...
  try {
    ...
    const appliedSummary = applied?.summary && typeof applied.summary === 'object'
      ? applied.summary
      : {};
    let visibleLocation = '';
    if (appliedSummary.focusedKind === 'node' && appliedSummary.focusedNodeName) {
      visibleLocation = Number(appliedSummary.visibleBlockCount || 0) > 0
        ? `\u5df2\u81ea\u52a8\u6253\u5f00\u201c${appliedSummary.focusedNodeName}\u201d\u8282\u70b9\uff0c\u5e76\u663e\u793a\u5176\u4e2d ${Number(appliedSummary.visibleBlockCount)} \u4e2a\u53ef\u89c1\u79ef\u6728\u3002`
        : `\u5df2\u81ea\u52a8\u5b9a\u4f4d\u5230\u201c${appliedSummary.focusedNodeName}\u201d\u8282\u70b9\uff1b\u8be5\u8282\u70b9\u5f53\u524d\u6ca1\u6709\u5185\u90e8\u79ef\u6728\u3002`;
    ...
    return {
      success: true,
      summary: [String(generated.summary || '\u8282\u70b9\u903b\u8f91\u5df2\u7ecf\u751f\u6210\u5e76\u4fdd\u5b58\u3002').trim(), visibleLocation]
        .filter(Boolean)
        .join('\n'),
