...
class StreamDispatcher:
    def __init__(self, emit_editor_event):
        self._emit_editor_event = emit_editor_event
    ...
    def dispatch_chunk(self, chunk: str, request_id: str | None, token: str | None) -> str:
        ...
        self._emit_editor_event("ai-chunk", [result])
        logger.debug(
    ...
    def dispatch_error(self, error_payload: str):
        self._emit_editor_event("ai-chunk", [error_payload])
